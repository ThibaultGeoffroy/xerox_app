...
<script src="/XeroxJavascriptLibrary/XRXUtilities.js" type="text/javascript"></script>
	...
	<link href="CSS/MidPageStyle.css" type="text/css" rel="stylesheet" />
...
/****************************************  Initialize  *************************************************/
		...
		function init()
		{
			...
			xrx_load_widgets();
			//alert("eipversion on Mainmidpage.jsp"+document.getElementById( 'EipVersion').innerHTML);
		}
...
/**************************************  Command functions  *********************************************/
		...
		*/
		...
		{
			//alert("Inside MainMidPage.jsp --> gotoScanPage method")
			saveOptions();
			//sendPage();
			//alert("Inside MainMidPage.jsp --> gotoScanPage method -- before submit")
    	 ...
    	 function changeClass(inputName )
		    {  
		     
		   // if(navigator.appVersion.indexOf("X2G")!=-1)
		     ...
		     switch(inputName)
				...
				case 'PrintOptions'  :
										...
										document.getElementById( inputName + 'Selectionsh' ).className = document.getElementById( inputName + 'Selectionsh' ).className +"second";
										document.getElementById( inputName + 'Label' ).className = document.getElementById( inputName + 'Label' ).className +"second";
		    							break;
				case 'titlepane'     : //alert("title pane area");
                                       document.getElementById( inputName ).className = document.getElementById( inputName ).className +"second";
                                       break;
...
<body>
	<form action="MainMidPage" method="get">
			...
			<div class="fullpane secondPage" id="fullpane" style="margin:10px 0 0 0;">
				...
				<div class="DestinationSelections" id="DestinationSelectionsh">
					<select class="xrx:radio" name="DestinationSelections" id="DestinationSelections">
						...
						<option disabled="disabled">Scan to Dave</option>
