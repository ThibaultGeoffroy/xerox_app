...
<!-- Xerox Javascript Webservices Library -->
	...
	<script language="JavaScript" type="text/javascript">
		...
		{   
			...
			//alert(document.getElementById( 'ServerAddress' ).value);
...
<body>
    <form name="ApplicationServerDetails" action="AppServerDetails" method="post">
		...
		<div class="xrx:ProgramAreaPanel" id="xrx:ProgramAreaPanel" >
			<div style="margin:10px 0 10px 10px;"  class="titleBox">
				<div class="titlepane" id="titlepane" style="color:white;"> SMB Server Information</div>	
			</div>	
			
	    	<div class="formDesign fourthPage" id="fullpane" style="margin:10px 0px 0 10px; clear:both;">
			<div class="floatLeft clear btmSpace">
	    		<div class="box">
				    <label id="lblSMBServerIPAddres">SMB Server IP:</label>     
				    <input type="text" id="SMBServerIPAddres" name="SMBServerIPAddres" class="xrx:keyboardtext" onenter="validKeys" />
			    </div>
	    	   	<div  class="box"><br>
				    <label id="ApplblServerDomName">Domain Name:</label>     
				    <input type="text" id="AppServerDomainName" name="AppServerDomainName" class="xrx:keyboardtext" onenter="validKeys" />
			    </div>
			   	<div class="box"><br>
				    <label id="ApplblServerUsrName">User Name:</label>   
				    <input type="text" id="AppServerUserName" name="AppServerUserName" class="xrx:keyboardtext" onenter="validKeys"/>
			    </div>
			    </div>
			    <div class="floatRight topSpace">
			   	<div class="box">
				    <label id="ApplblServerPwd">Password:</label>   
				    <input type="password" id="AppServerPassword" name="AppServerPassword" class="xrx:keyboardtext" onenter="validKeys"/>
				</div>
			    <div class="box"><br>
				    <label id="ApplblServerMainShrFol">Share:</label>    
				    <input type="text" id="AppServerMainSharFol" name="AppServerMainSharFol" class="xrx:keyboardtext" onenter="validKeys"/>
				</div>
			    <div class="box"><br>
				    <label id="ApplblServerSubShrFol">Document Path:</label>  
				    <input type="text" id="AppServerSubSharFol" name="AppServerSubSharFol" class="xrx:keyboardtext" onenter="validKeys"/>
			    </div>
			    </div>
        	</div>
