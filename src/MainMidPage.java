...
/**
 * Servlet implementation class MainMidPage
 */
public class MainMidPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dem.writeAboutLogs("Info", "Entering the doGet method of MainMidPage file", 2);
		...
		System.out.println("Eipversion on MainMidpage"+request.getParameter("EipVersion"));
		...
		dem.writeAboutLogs("Info", "Exiting the doGet method of MainMidPage file", 2);
	...
	*/
	...
	{
		dem.writeAboutLogs("Info", "Entering the ToggleScreen method of MainMidPage file", 2);
        String strVersion = "1";
        String strVer = "";
		try 
		{
        ...
        try
		{
        	dem.writeAboutLogs("info", "Inside requestDispatcher of doGet method of MainMidPage file -> StartScanPage.jsp", 2);
		...
		{
			dem.writeAboutLogs("Error", "Entering Catch section in ToggleScreen method of MainMidPage file with error argument: "+ex.getMessage(), 2);
	...
	{
		dem.writeAboutLogs("Info", "Entering checkClassVersion method of MainMidPage file", 2);
        ...
        dem.writeAboutLogs("Debug", "Entering checkClassVersion method of MainMidPage file having magic value: "+magic, 2);
        if(magic != 0xcafebabe) 
        {
        	dem.writeAboutLogs("Error", "Entering exception section in checkClassVersion method of MainMidPage file with error argument: Invalid Java class ", 2);
        	throw new IOException("Invalid Java class");
        }
        int minor = dataIS.readUnsignedShort();
        int major = dataIS.readUnsignedShort();
        dataIS.close();
        dem.writeAboutLogs("Debug", "Entering checkClassVersion method of MainMidPage file having major value: "+major, 2);
        dem.writeAboutLogs("Debug", "Entering checkClassVersion method of MainMidPage file having minor value: "+minor, 2);
        dem.writeAboutLogs("Info", "Exiting checkClassVersion method of MainMidPage file", 2);
        return major + " . " + minor;
	}
}
