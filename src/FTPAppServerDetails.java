...
/**
 * Servlet implementation class FTPAppServerDetails
 */
public class FTPAppServerDetails extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String strdomainName,strusrName,strpassword,strServerLogin,strRepositoryVolume,strDocumentPath,strIPAddress;   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FTPAppServerDetails() {
        super();
        dem=new DemAppLog();
    ...
    private static final String FMT_URL = "https://%1$s/%2$s";
   	...
   	private String BuildUri(String Destination)
   	{
   		...
   		dem.writeAboutLogs("Debug", "Inside BuildUri method of FTPAppServerDetails file having DestinationUri: "+DestinationUri, 2);
   	...
   	private String BuildSimpleUri(String Destination)
   	{
   		...
   		dem.writeAboutLogs("Debug", "Inside BuildSimpleUri method of FTPAppServerDetails file having DestinationUri: "+DestinationUri, 2);
   		return DestinationUri;
   	}
	/**
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dem.writeAboutLogs("Info", "Entering the doGet method of FTPAppServerDetails file", 2);
		System.out.println("Inside FTP AppServerDetails.java");
		...
		request.setAttribute("ScanLocation", request.getParameter("FTPAppServerSubSharFol"));
		request.setAttribute("FTPServerIPAddress", request.getParameter("FTPAppServerIpAddr"));
		...
		strdomainName = request.getParameter("FTPAppServerDomainName");
		dem.writeAboutLogs("Debug", "Inside doGet method of FTPAppServerDetails file having domain Name: "+strdomainName, 2);
		strusrName = request.getParameter("FTPAppServerUserName");
		dem.writeAboutLogs("Debug", "Inside doGet method of FTPAppServerDetails file having user Name: "+strusrName, 2);
		strpassword = request.getParameter("FTPAppServerPassword");	
		dem.writeAboutLogs("Debug", "Inside doGet method of FTPAppServerDetails file having password: "+strpassword, 2);
		strDocumentPath = request.getParameter("FTPAppServerSubSharFol");
		dem.writeAboutLogs("Debug", "Inside doGet method of FTPAppServerDetails file having Document Path: "+strDocumentPath, 2);
		strIPAddress = request.getParameter("FTPAppServerIpAddr");
		dem.writeAboutLogs("Debug", "Inside doGet method of FTPAppServerDetails file having IPAddress: "+strIPAddress, 2);
		strServerLogin = strusrName + "," + strpassword;
		...
		SetTemplate(request, response);
		 ...
		 try
		 {
			    dem.writeAboutLogs("Debug", "Inside request dipatcher of doGet method of FTPAppServerDetails file ->ScanPage.jsp", 2);
		 ...
		 catch(Exception ex)
		 {
				...
				dem.writeAboutLogs("Error", "Inside request dipatcher catch block of doGet method of FTPAppServerDetails file with message: "+ex.getMessage(), 2);
		 }
	}
	...
	{
		dem.writeAboutLogs("Info", "Entering the SetTemplate method of FTPAppServerDetails file", 2);
		setDevice(request.getRemoteHost());
	    setSecured(false);
	    setServiceURL(BuildUri(getDevice()));
	    dem.writeAboutLogs("Debug", "Inside SetTemplate method of FTPAppServerDetails file setting Device: "+request.getRemoteHost(), 2);
	    dem.writeAboutLogs("Debug", "Inside SetTemplate method of FTPAppServerDetails file setting ServiceURL: "+BuildUri(getDevice()), 2);
		...
		try {
			...
			e.printStackTrace();
			dem.writeAboutLogs("Error", "Inside SetTemplate catch block of doGet method of FTPAppServerDetails file with message: "+e.getMessage(), 2);
		}
		...
		if (objTmplEntriesE != null)
		{
			...
			if(objTmplEntry!=null)
			{
				...
				dem.writeAboutLogs("Debug", "Inside SetTemplate method of FTPAppServerDetails file having TmplCount: "+nTmplCount, 2);
				...
				dem.writeAboutLogs("Debug", "Inside SetTemplate method of FTPAppServerDetails file having nCheckSum: "+nCheckSum, 2);
		}
	}
	...
	{
		boolean bRet = false;
		dem.writeAboutLogs("Info", "Entering the DeleteTemplate method of FTPAppServerDetails file", 2);
		XrxTemplateManagementServiceStub proxy = null;
		try {
		...
		dem.writeAboutLogs("Debug", "Inside DeleteTemplate method of FTPAppServerDetails file setting strTmplName: "+strTmplName, 2);
		TemplateChecksum objTmplCS = new TemplateChecksum();
		objTmplCS.setTemplateChecksum(nCheckSum);
		dem.writeAboutLogs("Debug", "Inside DeleteTemplate method of FTPAppServerDetails file setting nCheckSum: "+nCheckSum, 2);
	...
	{
		dem.writeAboutLogs("Info", "Entering the CreateTemplate method of FTPAppServerDetails file", 2);
		System.out.println("entering CreateTemplate");
		String[] strLogin = new String[2];
		String strSplitter = ",";
				
		String strOrnt = request.getParameter("Orientation");
		dem.writeAboutLogs("Debug", "Inside CreateTemplate method of FTPAppServerDetails file with Orientaion value: "+strOrnt, 2);
		...
		System.out.println("FTPAppServerSubSharFol :" +strDocumentPath);
		System.out.println("FTPAppServerIpAddr :" +strIPAddress);		
		System.out.println("FTPAppServerDomainName :" +strdomainName);
		System.out.println("FTPAppServerUserName : " +strusrName);
		System.out.println("FTPAppServerPassword :" +strpassword);
		System.out.println("serverLogin :" +strServerLogin);
		dem.writeAboutLogs("Debug", "Inside CreateTemplate method of FTPAppServerDetails file with DocumentPath value: "+strDocumentPath, 2);
		dem.writeAboutLogs("Debug", "Inside CreateTemplate method of FTPAppServerDetails file with IPAddress value: "+strIPAddress, 2);
		dem.writeAboutLogs("Debug", "Inside CreateTemplate method of FTPAppServerDetails file with domainName value: "+strdomainName, 2);
		dem.writeAboutLogs("Debug", "Inside CreateTemplate method of FTPAppServerDetails file with usrName value: "+strusrName, 2);
		dem.writeAboutLogs("Debug", "Inside CreateTemplate method of FTPAppServerDetails file with password value: "+strpassword, 2);
		dem.writeAboutLogs("Debug", "Inside CreateTemplate method of FTPAppServerDetails file with ServerLogin value: "+strServerLogin, 2);
        ...
        String strTmpl = 
            ...
            + "* string RepositoryName = \"" + strIPAddress + ":21" + "\";\n"
           ...
           // + "* string RepositoryName = \"" + request.getParameter("ServerAddress") + "\";\n"
            ...
            + "* string UserNetworkFilingLoginName = \"" + strLogin[0] + "\";\n"           
            + "* string UserNetworkFilingLoginID = \"" + strLogin[1] + "\";\n"
			+ "}\n"
			+ "end\n";
	...
	{
		dem.writeAboutLogs("Info", "Entering the UploadTemplate method of FTPAppServerDetails file", 2);		
		int nCSum = 0;
		...
		TemplateName objTmplName = new TemplateName();
		objTmplName.setTemplateName(strTmplName);
		dem.writeAboutLogs("Debug", "Inside UploadTemplate method of FTPAppServerDetails file setting strTmplName: "+strTmplName, 2);
		TemplateContent objTmplCtnt = new TemplateContent();
		objTmplCtnt.setTemplateContent(strTemplate);
		dem.writeAboutLogs("Debug", "Inside UploadTemplate method of FTPAppServerDetails file setting strTemplate: "+strTemplate, 2);
		...
		XrxTemplateManagementServiceStub proxy = null;
		try {
			dem.writeAboutLogs("Debug", "Inside UploadTemplate method of FTPAppServerDetails file having strURL: "+strURL, 2);
			proxy = new XrxTemplateManagementServiceStub(strURL);
			//proxy = new XrxTemplateManagementServiceStub("http://13.121.176.42");
		} catch (AxisFault e) {
			// TODO Auto-generated catch block
		...
		dem.writeAboutLogs("Debug", "Exiting UploadTemplate method of FTPAppServerDetails file having nCSum: "+nCSum, 2);
		return nCSum;
	}
	...
	private String ConvertValue( String strValue )
	{
		...
		dem.writeAboutLogs("Debug", "Inside ConvertValue method of FTPAppServerDetails file with value: "+strValue, 2);
		...
		dem.writeAboutLogs("Debug", "Exiting ConvertValue method of FTPAppServerDetails file with value: "+strValue, 2);
		return strValue;
	}
}
